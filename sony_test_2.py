...
if __name__ == "__main__":
    ...
    VIDEO_DIR = '/home/saket/vision/sony/generative_inpainting/examples/sony/input_videos'
    MASK_DIR = '/home/saket/vision/sony/generative_inpainting/examples/sony/mask'
    OUTPUT_DIR = '/home/saket/vision/sony/generative_inpainting/examples/sony/output_videos'
    TEMP_DIR = '/home/saket/vision/sony/generative_inpainting/examples/sony/temp'
    TEMP_INPUT_DIR = '/home/saket/vision/sony/generative_inpainting/examples/sony/temp/input'
    TEMP_OUTPUT_DIR = '/home/saket/vision/sony/generative_inpainting/examples/sony/temp/output'
    ...
    input_image = tf.placeholder(shape = (1, 480, 1312, 3), dtype=tf.float32, name='fdfd')
    ...
    for video_name in os.listdir(VIDEO_DIR):
        ...
        mask_path = os.path.join(MASK_DIR, video_name).replace('mp4', 'png')
